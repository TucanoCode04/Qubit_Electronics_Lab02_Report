...
\begin{align*}\lambda_0 &= \frac{c}{f} = \frac{3 \times 10^8 \text{ m/s}}{2.275 \times 10^9 \text{ Hz}} \approx 131.87 \text{ mm} \[10pt]\lambda_g &= \frac{\lambda_0}{\sqrt{\epsilon_{eff}}} \approx \frac{131.87 \text{ mm}}{\sqrt{3.3}} \approx 72.59 \text{ mm} \[10pt]L_{stub} &\approx \frac{\lambda_g}{4} \approx \frac{72.59 \text{ mm}}{4} \approx 18.15 \text{ mm}\end{align*}

The resulting guided wavelength is in the order of millimeters. When divided by four, the calculated length $L_{stub} \approx 18.15 \text{ mm}$ is perfectly consistent with the physical dimensions of the stubs observed in the device (Fig. \ref{fig:device}). This confirms that the device was specifically designed to notch out frequencies in the $2.3 \text{ GHz}$ range,
